...
import { toolGroups } from "@/assets/data/tools"
...
export default function TechTools() {
    return (
        <section
            id="tech-tools"
            className="relative flex min-h-screen items-center overflow-hidden bg-[#091410] px-5 pb-32 pt-24 sm:px-8 md:py-24 md:pr-24 lg:px-12 lg:pr-28"
        >
            <div
                aria-hidden="true"
